return {
	...
	exclude_files = { "**/test/**/*.lua", "**/*API_defs.lua", "**/ext/*.lua", "archive/**/*.lua", "configs/**/*.lua" },
	globals = { "LuaExportStart", "LuaExportStop", "LuaExportBeforeNextFrame", "LuaExportAfterNextFrame" }, -- provided by dcs environment
	read_globals = {
		-- DCS hook environment globals
		"DCS", -- DCS namespace (getMissionName, getModelTime, setUserCallbacks, etc.)
		"net", -- net namespace (get_player_info, etc.)
		"env", -- env namespace (env.mission.theatre, etc.)
