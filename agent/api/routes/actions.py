...
Supported: start | stop | restart | logs_bundle | mission_load | minimize_window | reset_persist | set_password
...
set_password requires a JSON body: {"password": "..."}

DCS update is host-wide (not per-instance): POST /host/update
"""
